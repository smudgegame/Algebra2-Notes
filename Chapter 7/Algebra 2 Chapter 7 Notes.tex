...
\begin{definition}
Functions with a variable exponent is known as an \textbf{exponential function}. The parent exponential function is $f(x)=b^x$, where the \textbf{base} $b$ is a constant and the exponent $x$ is the independent variable.
\end{definition}
